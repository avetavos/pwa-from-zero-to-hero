...
**Precaching** เกิดขึ้นตอน service worker install คุณระบุ URL ที่ต้องการแคชอย่างชัดเจน แล้ว browser จะดึงและเก็บไฟล์เหล่านั้นก่อนที่ SW จะ activate วิธีนี้เหมาะที่สุดสำหรับ app shell ของคุณ — ไฟล์ HTML, CSS, และ JS ที่ประกอบเป็นโครงสร้างหลักของ UI
...
export const quizIndex = [
  {
    ...
    options: [
      'Precaching เก็บ asset ตอน install time; runtime caching เก็บตอน request ครั้งแรก',
