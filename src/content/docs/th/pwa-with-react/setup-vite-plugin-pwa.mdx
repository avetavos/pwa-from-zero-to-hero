...
Vite PWA ecosystem เป็น plugin มาตรฐานที่โปรเจกต์จริงอย่าง Elk (Mastodon client) ใช้ทำ PWA เต็มรูปแบบบน Vite/React ([Elk's `package.json` ระบุ `vite-plugin-pwa`](https://github.com/elk-zone/elk)) และหลาย VitePress sites ก็ใช้ setup เดียวกันนี้ทำให้ documentation site หลายพันเว็บกลายเป็น installable PWA ได้ง่าย
