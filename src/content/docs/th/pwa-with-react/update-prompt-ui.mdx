...
Vite PWA ecosystem อย่างที่ Elk ใช้อยู่ แสดง toast "New content available, click to reload" ผ่าน hook `virtual:pwa-register` เป็น pattern มาตรฐาน — แอปประเภทเอกสารหรืออีเมลที่ต้องปกป้องงานที่ยังทำค้างอยู่ มักใช้ banner แบบไม่รบกวนคล้ายกันนี้แทนการ force reload กลางเซสชัน
...
export const quizUpdatePromptUi = [
  ...
  },
  {
    ...
    options: [
      ...
      'เพราะ virtual: module ไม่ใช่ไฟล์จริง TypeScript จึงต้องการ declaration',
