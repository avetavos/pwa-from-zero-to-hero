...
Vite PWA ecosystem อย่างที่ Elk ใช้ ครอบ virtual:pwa-register ด้วย hook เพื่อให้ UI แจ้งเตือน update ได้แบบ declarative ส่วน Squoosh — PWA open source อีกตัวจาก Google Chrome Labs — ก็ผูก service worker lifecycle เข้ากับ UI state เพื่อแจ้งผู้ใช้เมื่อมีเวอร์ชันใหม่พร้อมใช้
