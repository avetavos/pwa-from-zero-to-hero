...
แอปประเภทอีเมลหรือเอกสารที่ต้องใช้งานได้ offline มักเก็บ draft และข้อมูลล่าสุดไว้ใน IndexedDB เพื่อให้ผู้ใช้ยังอ่านและแก้ไขต่อได้แม้ไม่มีการเชื่อมต่อ แล้ว sync กลับ server ทันทีที่กลับมามีเน็ต — เป็น pattern เดียวกับที่สร้างไว้ในบทเรียนนี้
