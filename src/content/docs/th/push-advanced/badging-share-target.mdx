...
แอปแชทที่ใช้ App Badging แสดงจำนวนข้อความที่ยังไม่อ่านบน icon ทันทีเหมือนแอป native และเครื่องมือที่ implement Share Target ให้ผู้ใช้แชร์รูปจากแอปอื่นเข้ามาประมวลผลได้ทันที ล้วนเป็นการใช้งานจริงทั่วไปของสอง API นี้
