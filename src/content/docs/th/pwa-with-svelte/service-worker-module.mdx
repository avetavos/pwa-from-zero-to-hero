...
[เอกสาร service worker ทางการของ SvelteKit](https://svelte.dev/docs/kit/service-workers) เสนอ `$service-worker` เป็นแนวทางมาตรฐานสำหรับทุกโปรเจกต์ SvelteKit ที่ต้องการ precache แบบ build-aware และหลายโปรเจกต์ที่สร้างบน SvelteKit ก็ต่อยอดจาก module นี้เพื่อทำ offline-first app
