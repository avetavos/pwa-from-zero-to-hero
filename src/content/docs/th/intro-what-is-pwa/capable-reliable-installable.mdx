...
**Twitter Lite** ทำ Reliable layer แบบ offline-first ก่อน แล้วค่อยเพิ่ม Installable ทีหลัง — สอดคล้องกับลำดับการ rollout service worker แบบค่อยเป็นค่อยไปที่ระบุไว้ใน case study ([web.dev/twitter](https://web.dev/twitter/))
