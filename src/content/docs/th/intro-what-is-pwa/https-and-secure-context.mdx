...
ในทางปฏิบัติ:
- เซิร์ฟเวอร์ dev ท้องถิ่นของคุณบน `http://localhost:5173` เป็น secure context ที่สมบูรณ์
- Service worker, Push API และ Web Authentication ทั้งหมดทำงานได้บน localhost โดยไม่ต้องมีใบรับรอง TLS
