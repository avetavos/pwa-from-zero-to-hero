...
แอปประเภทเอกสารหรืออีเมลที่ต้องปกป้องงานที่ยังทำค้างอยู่ มักตรวจ service worker ใหม่เบื้องหลังแล้วแจ้งผ่าน UI แทนการ force reload กลางเซสชัน โดยเช็กเป็นระยะด้วย `registration.update()` แล้วให้ผู้ใช้เลือกเองว่าจะรับเวอร์ชันใหม่เมื่อไร — นี่คือ pattern เดียวกับที่สร้างไว้ด้านบน
