...
description: 'service worker คืออะไร โมดูลนี้ครอบคลุมเรื่องอะไรบ้าง และเข้ามาเป็นส่วนหนึ่งของ PWA ได้อย่างไร'
sidebar:
  order: 1
---
...
service worker ทำงานอยู่เบื้องหลังโดยไม่มีสิทธิ์เข้าถึง DOM — คอยดักจับ network request ที่อยู่ภายใน scope ของตัวเอง ทุกอย่างที่ PWA ทำได้ในโหมดออฟไลน์ล้วนไหลผ่านเลเยอร์ programmable เดียวนี้ทั้งหมด
</Callout>
...
export const quizSwOverview = [
  ...
  },
  {
    ...
    options: [
      'ทำงานอยู่บน server',
      'ดักจับและสามารถตอบสนองต่อทุก network request ได้',
      'เก็บข้อมูลไว้ใน localStorage',
      'อ่านและเขียนไปยัง DOM',
    ],
    answer: 1,
  },
  {
