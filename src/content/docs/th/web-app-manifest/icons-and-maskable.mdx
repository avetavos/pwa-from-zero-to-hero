...
Squoosh ออกแบบ maskable icon เฉพาะสำหรับ Android โดยเว้น safe zone ตรงกลางตามสเปก ทำให้โลโก้ไม่โดนตัดเมื่อถูก crop เป็นวงกลม ([source บน GitHub](https://github.com/GoogleChromeLabs/squoosh) — มีไฟล์ `icon-large-maskable.png` อยู่จริง) ส่วน [Maskable.app](https://maskable.app/) เป็นเครื่องมือ preview มาตรฐานที่นักพัฒนา PWA ใช้ตรวจ safe zone ก่อน ship icon จริง — เป็นเครื่องมือของชุมชนที่ดูแลโดย Tiger Oakes ไม่ใช่ผลิตภัณฑ์ทางการของ Google
...
export const quizIconsMaskable = [
  ...
  },
  {
    ...
    options: [
      'icon จะถูกละเว้น',
      'browser จะยืดให้เป็นขนาดใด ๆ ที่ต้องการ',
