...
**Twitter Lite** ปรับ `theme_color` ให้ตรงกับ brand color ของตัวเองตอนสร้าง PWA ใหม่ ทำให้ status bar กลมกลืนกับ UI ทันทีที่เปิดจาก home screen ([web.dev/twitter](https://web.dev/twitter/))
