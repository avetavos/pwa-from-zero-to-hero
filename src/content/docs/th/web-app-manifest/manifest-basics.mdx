...
Squoosh — PWA บีบอัดรูปภาพแบบ open source ของ Google Chrome Labs — เขียน manifest ที่ครบทุก field จำเป็นตั้งแต่ต้น ([source บน GitHub](https://github.com/GoogleChromeLabs/squoosh)) เป็นตัวอย่างที่ดีในการดู manifest จริงนอกเหนือจาก demo ในบทนี้
