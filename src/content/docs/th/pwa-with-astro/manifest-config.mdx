...
Astro documentation site เองใช้ `@vite-pwa/astro` ตั้งค่า manifest ผ่าน config ให้ sync กับ build pipeline อัตโนมัติ และ VitePress sites หลายเว็บก็ใช้แนวทาง config-driven manifest คล้ายกันทำให้ documentation หลายพันเว็บติดตั้งเป็น PWA ได้โดยไม่ต้องเขียน manifest.json เอง
