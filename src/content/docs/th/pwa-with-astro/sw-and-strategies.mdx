...
`@vite-pwa/astro` ecosystem ให้ทั้งสอง mode นี้เป็นทางเลือก โปรเจกต์ documentation ส่วนใหญ่ใช้ generateSW เพราะพอสำหรับ static site ส่วนแอปที่มี custom offline logic ซับซ้อนมักเลือก injectManifest เพื่อผสม custom fetch handler เข้ากับ precache list ที่ Workbox generate ให้
...
export const quizSwAndStrategies = [
  ...
  },
  {
    ...
    options: [
      'จะ generate web app manifest ในขั้นตอน build',
      'ให้ฟังก์ชัน registerSW สำหรับจัดการ callback การอัปเดตและ offline-ready',
      'แทนที่ self.__WB_MANIFEST ด้วย precache list จริง',
      'ติดตั้ง workbox-precaching เป็น dev dependency',
    ],
    answer: 1,
  },
  {
