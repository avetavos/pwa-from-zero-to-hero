...
Documentation site ที่ build ด้วย Astro หรือ static-site generator แบบเดียวกันมักผสาน SSG กับ service worker precache ทำให้ documentation เปิดอ่านได้แบบ offline ทันทีหลังเข้าชมครั้งแรก และเว็บบล็อกจำนวนมากที่ build ด้วย Astro ก็ใช้แนวทาง precache ทั้งเว็บเพราะขนาดไฟล์รวมเล็กพอจะทำได้จริง — trade-off เดียวกับตารางด้านบนนี้ใช้ได้กับทั้งสองกรณี
